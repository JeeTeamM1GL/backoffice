...
const data: IMemoire[] = [
  {
    ...
    document: "vide",
    year: "2024",
    bibliotheque: { nom: "vide", description: "vide" },
    filiere: { intitule: "GL" },
    classe: { nom: "M1" },
  },
  {
...
function Bibliotheque() {
  // const [bibliotheques , setMemoires] = useState([]);
  // const [loading , setLoading] = useState(false);
  // useEffect(() => {
  //     setLoading(true)
  //     getActions(endpoints.bibliotheques.LIST)
  //     .then((response : any)=>{
  ...
  const onDelete = (id: any) => {
    deleteActions(endpoints.bibliotheques.DELETE + "" + id)
      .then((res) => {
  ...
  return (
    <Card>
      ...
      />
      <Modal footer={null} title={<Title level={4}>{operation === "add" ? "Nouvelle bibliotheque" : "Modifier bibliotheque"}</Title>} open={isModalOpen} onOk={handleOk} onCancel={handleCancel} destroyOnClose>
